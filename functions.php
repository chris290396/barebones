...
function barebones_enqueue_scripts() {
    wp_enqueue_style( 'fonts', '//fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600' );
    // wp_enqueue_style( 'icons', '//use.fontawesome.com/releases/v5.0.10/css/all.css' );
    wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . '/assets/styles/style.css?' . filemtime( get_stylesheet_directory() . '/style.css' ) );
